-- Hae seuraavat tiedot kaikille valmistajille: valmistajan tunnus ja nimi sekä valmistajan valmistamien jäätelöiden lukumäärä, pienin valmistuskustannus ja suurin valmistuskustannus.
...
FROM Manufacturer
    LEFT JOIN Ice_cream ON Ice_cream.manufacturer_id = Manufacturer.manufacturer_id
